...
**[Google Sheets 템플릿 복사하기](https://docs.google.com/spreadsheets/d/TEMPLATE_SHEET_ID/copy)**
...
|---------|------|---------|-------|-------|-------------|------------|--------------|
| ERR_NETWORK | TOAST | 네트워크 연결을 확인해주세요 | | | | | |
| ERR_AUTH | MODAL | 인증이 필요합니다 | 로그인 필요 | | 로그인하기 | REDIRECT | /login |
| ERR_TIMEOUT | MODAL | 요청 시간이 초과되었습니다 | 시간 초과 | | 다시 시도 | RETRY | |
| ERR_FORBIDDEN | PAGE | {{userName}}님은 접근 권한이 없습니다 | 접근 거부 | /img/403.png | 뒤로가기 | BACK | |
