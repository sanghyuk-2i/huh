...
**[Duplicate Notion Template](https://notion.so/TEMPLATE_DB_ID)**
...
## 2. Creating an Integration and Getting a Token
...
## 3. Connecting the Integration to the Database
