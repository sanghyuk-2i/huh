---
title: 'Notion 연동 가이드'
description: 'Notion 데이터베이스에서 에러 콘텐츠를 관리하기 위한 설정 가이드'
...
**[Notion 템플릿 복제하기](https://www.notion.so/sanghyuk2i/Hur-Error-304d49b044d8808194a0fa50b490a6e2)**
...
::: tip
  Notion에서 `trackId`는 기본 Title 프로퍼티입니다. 기본 "Name" 프로퍼티의 이름을 `trackId`로
  변경하세요.
:::

::: tip
  `type`, `severity`, `actionType`은 Select 타입으로 설정하면 옵션을 미리 정의하여 입력 실수를
  방지할 수 있습니다. 커스텀 타입도 옵션에 추가할 수 있습니다. 소문자로 입력해도 CLI가 자동으로
  대문자로 변환합니다.
:::
