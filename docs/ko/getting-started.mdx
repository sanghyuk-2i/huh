...
<CardGroup cols={2}>
  <Card title="@sanghyuk-2i/huh-core API 레퍼런스" icon="cube" href="/ko/api/core">
    타입, 파싱, 검증 상세
  </Card>
  <Card title="@sanghyuk-2i/huh-react 가이드" icon="react" href="/ko/api/react">
    React Provider, 훅, 렌더러 상세
  </Card>
  <Card title="@sanghyuk-2i/huh-vue 가이드" icon="vuejs" href="/ko/api/vue">
    Vue 3 Provider, composable 상세
  </Card>
  <Card title="@sanghyuk-2i/huh-svelte 가이드" icon="svelte" href="/ko/api/svelte">
    Svelte 5 Provider, context 상세
  </Card>
  <Card title="@sanghyuk-2i/huh-cli 가이드" icon="terminal" href="/ko/api/cli">
    CLI 명령어 상세
  </Card>
  <Card title="CSV 파일 가이드" icon="file" href="/ko/guides/csv">
    로컬 CSV 파일 연동
