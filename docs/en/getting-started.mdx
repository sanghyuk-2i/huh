...
<CardGroup cols={2}>
  <Card title="@sanghyuk-2i/huh-core API Reference" icon="cube" href="/en/api/core">
    Types, parsing, validation details
  </Card>
  <Card title="@sanghyuk-2i/huh-react Guide" icon="react" href="/en/api/react">
    React Provider, hooks, renderer details
  </Card>
  <Card title="@sanghyuk-2i/huh-vue Guide" icon="vuejs" href="/en/api/vue">
    Vue 3 Provider, composable details
  </Card>
  <Card title="@sanghyuk-2i/huh-svelte Guide" icon="svelte" href="/en/api/svelte">
    Svelte 5 Provider, context details
  </Card>
  <Card title="@sanghyuk-2i/huh-cli Guide" icon="terminal" href="/en/api/cli">
    CLI command details
  </Card>
