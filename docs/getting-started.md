...
3. **React Provider** 에서 Track ID로 에러 UI 렌더링 (런타임)

## 설치

```bash
# React 프로젝트에서 사용하는 경우
pnpm add @huh/core @huh/react
pnpm add -D @huh/cli

# Node.js에서 core만 사용하는 경우
pnpm add @huh/core
```
...
데이터 소스별 설정 가이드:
- [Google Sheet 설정 가이드](./google-sheet-guide.md)
- [Airtable 연동 가이드](./airtable-guide.md)
- [Notion 연동 가이드](./notion-guide.md)
- [CSV 파일 가이드](./csv-guide.md)
- [XLSX 파일 가이드](./xlsx-guide.md)
...
- [@huh/core API 레퍼런스](./api-core.md) - 타입, 파싱, 검증 상세
- [@huh/react 가이드](./api-react.md) - Provider, 훅, 렌더러 상세
- [@huh/cli 가이드](./api-cli.md) - CLI 명령어 상세
- [CSV 파일 가이드](./csv-guide.md) - 로컬 CSV 파일 연동
- [XLSX 파일 가이드](./xlsx-guide.md) - 로컬 XLSX 파일 연동
